...
<c:url value="/j_spring_security_logout" var="logoutUrl" />
	...
	<div class="container-fluid">
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="directors.html"><spring:message code="label.addDirector" /></a></li>
	...
	<div class="container">
	<h3><spring:message code="label.director" /></h3>
	
		<form:form role="form" method="post" action="addDirector.html"
			...
			<spring:message code="label.enterfName" var="enter1"/>
			...
			<div class="form-group">
			<spring:message code="label.enterlName" var="enter2" />
				<label for="lastName"><spring:message code="label.lname" /></label>
				<form:input path="lastName" class="form-control" id="lastName"
					placeholder="${enter2 }"></form:input>
					<span style='color: red'><form:errors path="lastName"/></span>
			</div>
			<c:if test="${director.id==0}">
				<button type="submit" class="btn btn-default"><spring:message code="label.addDirector" /></button>
			</c:if>
			<c:if test="${director.id!=0}">
				<button type="submit" class="btn btn-default"><spring:message code="label.editDirector" /></button>
			</c:if>
		</form:form>
	</div>
	<div class="container">
	<h3><spring:message code="label.directorList" /></h3>
		...
		<table class="table">
			...
			<c:forEach items="${directorList}" var="director">
				<tr>
					...
					<td><a href="directors.html?directorId=${director.id}"><spring:message code="label.edit" /></a></td>
				</tr>
			</c:forEach>
		</table>
	</c:if>
